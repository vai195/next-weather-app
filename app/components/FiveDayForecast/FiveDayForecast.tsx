...
import { kelvinToFarenheit, unixToDay } from "@/app/utils/extraUtils";
...
function FiveDayForecast() {
  ...
  return (
    <div className='pt-6 pb-5 px-4 flex-1 border flex flex-col justify-between dark:bg-dark-grey shadow-sm dark:shadow-none'>
      <div>
